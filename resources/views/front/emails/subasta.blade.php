...
<style type="text/css">td img {display: block;}td { font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;padding:5px} .s1, .s2, .s3{    margin-top: 0; color: #2f3133; font-size: 15px; font-weight: bold; text-align: left;} .s2{ color:#0f345b; }.buttonArias{font-family:Arial,'Helvetica Neue',Helvetica,sans-serif;display:block;display:inline-block;width:200px;min-height:20px;padding:10px;background-color:#3869d4;border-radius:3px;color:#ffffff;font-size:15px;line-height:25px;text-align:center;text-decoration:none;background-color:#3869d4}
.s3{color:#e32525;}
.image {
...
<table style="display: inline-table;" border="0" cellpadding="0" cellspacing="0" width="700">
    ...
    @foreach($datos as $d)
        <tr>
            ...
            <td><span class="s2">{{$d->nombre}} </span></td>
             <td class="image" style="background-image:url(http://promocerealesgf.com.mx{{$d->image}})"></td>
        </tr>        
    @endforeach
    <tr id="file-1">
  ...
  <td style=""><span class="s1">* Recuerda que debes recortar el inserto que se te pedirá en caso de resultar ganador..</span></td>
  </tr>  
</table>
</div>
</body>
