            ...
            <div class="container">
                <div class="row" >
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-compra-equipo-minero-construccion-agricultura.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-venta-equipo-minero-construccion-agricultura.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-ollas-sand-blast-df-cdmx.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-venta-excavadoras-caterpillar.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-vibrocompactadores-seminuevos-raygo.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-helicopteros.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-fletes.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-mecanica-suelos-perforadoras-1.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-promin-drill.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-compra-venta-reconstruccion-locomotoras-mineras-trolley-diesel-flameproof-clayton.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-acero-barrenacion-df.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-bombas-concreto-kcp-cdmx-mexico-df.jpg')); ?>" alt="" class="img-responsive">
                            </a>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 text-center margin_top">
                        <div class="cimg">
                            <a href="ollas-sand-blast-df.php" class="aimg">
                                <img src="<?php echo e(url('assets/images/mosaico-brazo-telescopico-excavadoras-hidraulicas-cosben-mexico-cdmx-df.jpg')); ?>" alt="" class="img-responsive">
                            </a>
