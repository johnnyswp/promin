<a href="#" class="btn_carrito"><i class="fa fa-shopping-cart carrito"></i> <?php echo e(Cart::count()); ?> items - $ <?php echo e(Cart::subtotal()); ?></a>
<div class="dropdown" id="content-cart">
    ...
    <div class="hcart-total">
        ...
        <div class="total">Total: <ins>$ <?php echo e(Cart::subtotal()); ?></ins></div>
    </div>
</div>