        ...
        <div class="container sorting no_pad_top">
            <div class="row">
                ...
                <select class="form-control" name="linea" id="linea" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $lineas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($val->id); ?>" <?php if($val->id==$linea->id): ?> selected="selected" <?php endif; ?>><?php echo e($val->nombre); ?></option>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3 col-sm-6 citem">
                    <div class="cimg" style="min-height: 200px; max-height: 200px;">
                        <a href="<?php echo e(url('linea-negocio/'.str_slug($producto->linea()).'/'.str_slug($producto->nombre).'-'.$producto->id)); ?>" class="aimg" title="<?php echo e($producto->nombre); ?>"><img src="<?php echo e($producto->image()); ?>" alt="<?php echo e($producto->nombre); ?>"></a>
                    ...
                    <h5>
                        <a href="<?php echo e(url('linea-negocio/'.str_slug($producto->linea()).'/'.str_slug($producto->nombre).'-'.$producto->id)); ?>" class="black" title="<?php echo e($producto->nombre); ?>"><?php echo e($producto->nombre); ?></a>
