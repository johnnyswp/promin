            ...
            <ul class="datos_contacto">
                ...
                <li>
                    ...
                    <a href="/mi-cuenta">
                        ...
                        <img src=" <?php echo e(Auth::user()->picture); ?>" class="avatar img-circle">&nbsp;

                        <span class="header-username">Hola,  <?php echo e(Auth::user()->name); ?></span>
                ...
                <li>
                    ...
                    <a class="btn_login" href="<?php echo e(route('logout')); ?>"onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                ...
                <li><div class="hcart"><?php echo $__env->make('front.includes.carrito', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div></li> 
...
<div class="container borde_bottom hidden-xs hidden-sm">
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
             ...
             <a href="<?php echo e(url('/')); ?>"><img src="/assets/images/proveedora-equipos-mineros-promin-logo.png" alt="Proveedora de Equipos Mineros"></a>
