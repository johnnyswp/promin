    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            ...
            <ul class="datos_contacto">
                ...
                <li class="hidden-xs hidden-sm"><a data-popup="login" id="login_open"><i class="fa fa-sign-in"></i> Login</a></li>
...
<div class="container borde_bottom hidden-xs hidden-sm">
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
             ...
             <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('assets/images/proveedora-equipos-mineros-promin-logo.png')); ?>" alt="Proveedora de Equipos Mineros"></a>
