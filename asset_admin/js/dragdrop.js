...

{
    ...
    var group = $("div.drag").sortable({
        ...
        onDrop: function (item, container, _super) {
            var d = group.sortable("serialize").get();
            $.ajax({
              url: "/admin/positions-img",
              data:{datos:d},
...
var mitable =$('.sorted_table').sortable({
  ...
  onDrop: function  ($item, container, _super) {
    ...
    var ds = mitable.sortable("serialize").get();
    console.log(ds);
            $.ajax({
              url: "/admin/sortable/Banner",
              data:{datos:ds},
