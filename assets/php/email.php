...
define('EMAIL_ADMIN_SUBJECT', 'Feedback letter from contacts form on Camaro');
define('EMAIL_CLIENT_SUBJECT', 'Feedback letter from Camaro');
...
<div id="preloader">
    ...
    Hi, {$name}! <br/>
    You was sent message to administrators Camaro at {$datetime}.<br/><br/>
