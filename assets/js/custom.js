(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        activate: function () {
            ...
            instance.addCart.on('click', function(e){
                ...
                if (self.hasClass('btn-primary')){
                    self.removeClass('btn-primary').addClass('btn-default').text('Quitar de carrito');
                } else {
                    self.removeClass('btn-default').addClass('btn-primary').text('Agregar a carrito');
                }
            });
        ...
        contactMap: function() {
            var cmyLatlng = new google.maps.LatLng(19.3443550,-99.0304578);
            var myIcon = 'images/marcador-promin.png';
            var catIcon = {
                url: myIcon,
            };
            var cmapOptions = {
                ...
                styles: [{"featureType": "administrative", "elementType": "labels.text.fill", "stylers": [{"color": "#444444"}]}, {"featureType": "administrative.locality", "elementType": "labels.text.stroke", "stylers": [{"visibility": "on"}]}, {"featureType": "administrative.locality", "elementType": "labels.icon", "stylers": [{"visibility": "on"}, {"color": "#f1c40f"}]}, {"featureType": "landscape", "elementType": "all", "stylers": [{"color": "#666"}]}, {"featureType": "poi", "elementType": "all", "stylers": [{"visibility": "off"}]}, {"featureType": "road", "elementType": "all", "stylers": [{"saturation": -100}, {"lightness": 45}]}, {"featureType": "road.highway", "elementType": "all", "stylers": [{"visibility": "simplified"}]}, {"featureType": "road.arterial", "elementType": "labels.icon", "stylers": [{"visibility": "off"}]}, {"featureType": "transit", "elementType": "all", "stylers": [{"visibility": "off"}]}, {"featureType": "water", "elementType": "all", "stylers": [{"color": "#11a0da"}, {"visibility": "on"}]}]
            };
            ...
            new google.maps.Marker({
                ...
                map: cmap,
                icon: catIcon,
                title: 'PROMIN ® Proveedora de Equipos Mineros ®',
